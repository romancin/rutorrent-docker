...
| `-e CREATE_SUBDIR_BY_TRACKERS=YES` | YES to create downloads/watch subfolders for trackers (OLD BEHAVIOUR), NO to create only completed/watch folders (DEFAULT) or NOTHING for don't create any extra subfolder on download folder (NEW OPTION) |
