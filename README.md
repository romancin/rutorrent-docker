...
## Changelog
v7.0.0 (21/03/2022): Implement pyroscope installation optionally (current pyrocore installation scripts do not work, so don't use it, and the project seems unmaintained :() and a new option to wait for network to be ready. **NOTE**: Important changes made in rutorrent [#2236](https://github.com/Novik/ruTorrent/pull/2236) and [#2247] broke compatibility with v3.10 for some themes and plugins. For the moment, I am using certain forks from [stickz](https://github.com/stickz) (Thank you very much!) to fix certain plugins.
